...
支持多车型的纯静态维修资料库。当前收录 **981，2013–2015** 和 **982，2016 起**；所有主题展示按车型绘制的 Boxster 线稿，原有卡通图片保留在代码库中但不再用于封面。982 手册资料源标注为 2018，实际适用配置仍以原 PDF 为准。
...
- 981 与 982 车型页有“配件目录”入口，可搜索原厂号、品牌型号、机油、冷却液、刹车油、手动挡及 PDK 油液、差速器终传动油、空调冷媒、雨刷和保养滤芯等。PDK 离合器液与齿轮油分条，2018 年 718 机油按 PET 日期分界，冷媒按车载 KK1/KK3 标签核对；没有可信原厂商品号的冷媒会明确提示，不编造编号。品牌型号不自动等同原装供应件，订购前以 VIN 和配置为准。数据独立于维修手册导入，位于 `site/data/parts/`。
...
site/
  ...
  data/parts/981.json       981 常用配件、原厂号、品牌件型号与来源
  data/parts/982.json       982 常用配件、原厂号、品牌件型号与来源
  docs/981/                 981 PDF 切片
